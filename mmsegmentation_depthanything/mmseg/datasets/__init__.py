...
from .weather_proof import WeatherProofDataset, WeatherProofCleanDataset, WeatherProofTestDataset, WeatherProofExtraDataset
# yapf: disable
...
__all__ = [
    ...
    'WeatherProofDataset', 'WeatherProofCleanDataset', 'WeatherProofTestDataset', 'WeatherProofExtraDataset'
]
