...
def parse_args():
    ...
    # parser.add_argument('gpu', help='checkpoint file')
    parser.add_argument(
        '--work-dir',
...
def main():
    ...
    if rank == 0:
        if args.out:
            ...
            if len(results == dataset.img_infos) and args.eval is None:
                for result, img_info in zip(results, dataset.img_infos):
