...
_PREDEFINED_SPLITS_COCO_PANOPTIC = {
    "sku110k_2017_train_panoptic": (
        # This is the original panoptic annotation directory
        "sku110k/panoptic_train2017",
        "sku110k/annotations/panoptic_train2017.json",
        # This directory contains semantic annotations that are
        # converted from panoptic annotations.
        # It is used by PanopticFPN.
        # You can use the script at detectron2/datasets/prepare_panoptic_fpn.py
        # to create these directories.
        "sku110k/panoptic_semseg_train2017",
    ),
    "sku110k_2017_val_panoptic": (
        "sku110k/panoptic_val2017",
        "sku110k/annotations/panoptic_val2017.json",
        "sku110k/panoptic_semseg_val2017",
    ),
    "sku110k_100_2017_train_panoptic": (
        "sku110k/panoptic_train2017",
        "sku110k/annotations/panoptic_100_train2017.json",
        "sku110k/panoptic_semseg_train2017",
    ),"sku110k_1k_2017_train_panoptic": (
        "sku110k/panoptic_train2017",
        "sku110k/annotations/panoptic_1k_train2017.json",
        "sku110k/panoptic_semseg_train2017",
    ),
}
...
def register_sku110k_panoptic_annos_sem_seg(
...
def register_all_sku110k_panoptic_annos_sem_seg(root):
    for (
        prefix,
        ...
        # if prefix == "sku110k_100_2017_train_panoptic" or prefix == "sku110k_1k_2017_train_panoptic":
        #     prefix_instances = "sku110k_2017_train"
        instances_meta = MetadataCatalog.get(prefix_instances)
        image_root, instances_json = instances_meta.image_root, instances_meta.json_file
        # if 'val' in instances_json:
        #     instances_json = instances_json.replace('instances_', 'panoptic2instances_')

        register_sku110k_panoptic_annos_sem_seg(
            prefix,
            get_metadata(),
            image_root,
...
register_all_sku110k_panoptic_annos_sem_seg(_root)
